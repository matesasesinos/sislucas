...
<main role="main" class="col-md-9 ml-sm-auto col-lg-11 px-4">
    <div class="pt-3 pb-2 mb-3">
        <h4 class="h2 pb-3 mb-3 border-bottom  d-flex justify-content-between align-items-center">Clientes <a href="#" class="btn btn-info add-company" data-toggle="modal" data-target="#addCompany"><i class="fas fa-plus"></i></a></span></h4>
